...
class Sim:
    ...
    def __init__(self, adj_matrix, distributions, queue_list, seeds=None, num_runs=None, generate_log=False, log_path='logs/', log_name=None, animation=False, record_history=False, logging_mode='All', max_sim_time=1000, verbose=False):
        """
